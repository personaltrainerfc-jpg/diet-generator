...
import { UtensilsCrossed, History, PlusCircle, LogOut, PanelLeft, Leaf, Sun, Moon, BookOpen, Apple, Users, LayoutDashboard } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Apple, label: "Alimentos Custom", path: "/custom-foods" },
  { icon: Users, label: "Mis Clientes", path: "/clients" },
  ...
  if (!user) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-background via-secondary/30 to-accent/20">
        <div className="flex flex-col items-center gap-8 p-10 max-w-md w-full bg-card rounded-2xl shadow-xl border border-border/50">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm leading-relaxed">
              Inicia sesión para crear dietas personalizadas con inteligencia artificial.
            </p>
          </div>
          <Button
            onClick={() => {
